    ...
    <div className="space-y-8">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-500">Welcome back, Nipuni! Here's what's happening today.</p>
        </div>
            ...
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-slate-800 truncate">Customer Name {i}</p>
                  <p className="text-xs text-slate-500">Tesla Model 3 • 2 days</p>
                </div>
